...
/**
 * מעל טווח התצוגה הזה לא מציגים סמנים.
 *
 * נמדד מול השרת: ב-0.01 יש כ-36 תחנות בתצוגה, ב-0.02 כ-134, וב-0.03 כבר 292 —
 * מאות סמנים native שממילא חופפים זה את זה ואינם שמישים. במקומם מוצג רמז
 * להתקרב, וגם הבקשה לשרת נחסכת.
 */
export const MAP_MAX_MARKER_DELTA = 0.02;
