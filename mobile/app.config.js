...
module.exports = {
  expo: {
    ...
    plugins: [
      ...
      // האפליקציה עברית בלבד, ולכן הכיוון לא יכול להיגזר משפת המכשיר: משתמש
      // עם טלפון באנגלית היה מקבל פריסה לא משוקפת. סטטי ולא I18nManager בקוד,
      // כי forceRTL בזמן ריצה תופס רק אחרי הפעלה מחדש ו-expo-updates מושבת.
